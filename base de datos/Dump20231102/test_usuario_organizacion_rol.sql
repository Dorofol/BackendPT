...
--
-- Table structure for table `usuario_organizacion_rol`
--

DROP TABLE IF EXISTS `usuario_organizacion_rol`;
...
--
-- Dumping data for table `usuario_organizacion_rol`
--

LOCK TABLES `usuario_organizacion_rol` WRITE;
/*!40000 ALTER TABLE `usuario_organizacion_rol` DISABLE KEYS */;
/*!40000 ALTER TABLE `usuario_organizacion_rol` ENABLE KEYS */;
UNLOCK TABLES;
